...
const weeklyThemePalette: Record<WeeklyThemeColor, WeeklyThemeStyles> = {
  blue: {
    accent: "#003478",
    headerBg: "bg-hca-blue text-white",
    cellBg: "bg-hca-blue/5",
    cellBorder: "border-hca-blue/20",
    sidebarBorder: "border-l-4 border-l-hca-blue",
    sidebarBadge: "text-hca-blue",
  },
  red: {
    accent: "#C60C30",
    headerBg: "bg-hca-red text-white",
    cellBg: "bg-hca-red/5",
    cellBorder: "border-hca-red/20",
    sidebarBorder: "border-l-4 border-l-hca-red",
    sidebarBadge: "text-hca-red",
  },
  teal: {
    accent: "#003478",
    headerBg: "bg-hca-blue text-white",
  ...
  purple: {
    ...
    headerBg: "bg-hca-blue text-white",
    cellBg: "bg-hca-muted",
    cellBorder: "border-hca-border",
    sidebarBorder: "border-l-4 border-l-hca-blue",
    sidebarBadge: "text-hca-blue",
  },
  slate: {
    accent: "#111111",
    headerBg: "bg-hca-ink text-white",
    cellBg: "bg-hca-muted",
    cellBorder: "border-hca-border",
    sidebarBorder: "border-l-4 border-l-hca-ink",
    sidebarBadge: "text-hca-ink",
  },
};
